                ...
                child: Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: const Icon(Icons.close_rounded, color: Colors.black54, size: 24),
                    ),
                  ],
                ),
              ),
                                  ...
                                  children: [
                                    if (c.userId == _currentUserId) ...[
                                      SimpleDialogOption(
                                        ...
                                        child: Text('sc_menu_edit'.tr, style: const TextStyle(color: Colors.black87, fontSize: 16)),
                                      ),
                                      SimpleDialogOption(
                                        onPressed: () async {
                                          Navigator.pop(ctx);
                                        ...
                                        child: Text('sc_btn_delete'.tr, style: const TextStyle(color: AppColors.error, fontSize: 16)),
                                      ),
                                    ],
                                    if (c.userId != _currentUserId)
                                      SimpleDialogOption(
                                        ...
                                        child: Text('sc_menu_report'.tr, style: const TextStyle(color: Colors.black87, fontSize: 16)),
                                      ),
                                  ],
                                ),
                              );
                ...
                child: Row(
                  children: [
                    ...
                    CircleAvatar(
                      radius: 18,
                      backgroundColor: AppColors.brandLight,
                      backgroundImage: (_storage.user?.avatarUrl != null && _storage.user!.avatarUrl!.isNotEmpty)
                          ? CachedNetworkImageProvider(_storage.user!.avatarUrl!)
                          : null,
                      child: (_storage.user?.avatarUrl == null || _storage.user!.avatarUrl!.isEmpty)
                          ? const Icon(Icons.person, size: 20, color: AppColors.brand)
                          : null,
                    ),
                    const SizedBox(width: 12),
                    ...
                    Padding(
                      ...
                      child: _sendingComment
                          ...
                          : GestureDetector(
                              onTap: _commentController.text.trim().isEmpty ? null : _submitComment,
                              child: Container(
                                width: 36,
                                height: 36,
                                decoration: BoxDecoration(
                                  shape: BoxShape.circle,
                                  color: _commentController.text.trim().isEmpty ? Colors.grey.shade400 : AppColors.brand,
                                ),
